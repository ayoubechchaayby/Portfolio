...
// include: C:\Users\LENOVO~1\AppData\Local\Temp\tmpqdd3i6f0.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'jeu.data';
      var REMOTE_PACKAGE_BASE = 'jeu.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_jeu.data');
      }
      Module['addRunDependency']('datafile_jeu.data');
    ...
    loadPackage({"files": [{"filename": "/assets/bravo.png", "start": 0, "end": 746}, {"filename": "/assets/coffre_ferme.png", "start": 746, "end": 1464}, {"filename": "/assets/coffre_ouvert.png", "start": 1464, "end": 2183}, {"filename": "/assets/dictionnaire.txt", "start": 2183, "end": 3995}, {"filename": "/assets/fond.png", "start": 3995, "end": 6258}, {"filename": "/assets/gameover.png", "start": 6258, "end": 7040}, {"filename": "/assets/niveau.txt", "start": 7040, "end": 8530}, {"filename": "/assets/objets.png", "start": 8530, "end": 24954}, {"filename": "/assets/personnage_simple.png", "start": 24954, "end": 29487}, {"filename": "/assets/personnages.png", "start": 29487, "end": 39383}, {"filename": "/assets/vie.png", "start": 39383, "end": 40162}], "remote_package_size": 40162});

  })();

// end include: C:\Users\LENOVO~1\AppData\Local\Temp\tmpqdd3i6f0.js
// include: C:\Users\LENOVO~1\AppData\Local\Temp\tmpp_8y7vad.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\LENOVO~1\AppData\Local\Temp\tmpp_8y7vad.js
// include: C:\Users\LENOVO~1\AppData\Local\Temp\tmp1ubgacns.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\LENOVO~1\AppData\Local\Temp\tmp1ubgacns.js
...
var ASM_CONSTS = {
  170796: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 171011: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 171158: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
